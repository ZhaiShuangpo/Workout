...
export const DEFAULT_TECHNIQUE_CUES: Record<string, string[]> = {
  ...
  '双杠臂屈伸 (Dips)': [
    '躯干前倾：身体微向前倾斜约 15°~30°，手肘自然向后打开，重点刺激胸肌下沿与三头。',
    '下落深度：下落至大臂与地面平行即可，避免过度深降挤压肩袖前侧。',
    '顶峰锁定：推起至手臂伸直但不过度超伸手肘，顶峰胸大肌用力挤压。'
  ],
  '器械推胸': [
    '沉肩挺胸：背部与臀部紧贴靠垫，双脚踩实地面，握把高度对齐胸肌中部。',
    '呼气前推：沿器械固定轨迹向前推出，小臂与推杆方向一致。',
    '离心拉伸：缓慢还原并感受胸大肌受控拉伸，配重片不完全相撞以保持持续张力。'
  ],
  '下斜哑铃卧推': [
    '锁好双脚：下斜凳双脚勾紧固定架，收紧核心防身体滑脱。',
    '弧线推起：哑铃推起时手肘微朝前，顶点哑铃自然靠近，专注下胸收紧。',
    '安全放置：起落哑铃利用大腿辅助，切忌侧翻直接下扔哑铃。'
  ],
  'T杠划船': [
    '屈髋背直：双脚与肩同宽踏紧踏板，屈髋俯身，腰背保持中立刚性。',
    '拉向小腹：手柄拉向肚脐下方，手肘顺着躯干向后夹紧，上背与背阔肌剧烈收缩。',
    '避免借力：严禁利用大幅仰身或下肢弹震甩起大重量。'
  ],
  '窄握绳索划船': [
    '微屈膝挺胸：坐姿双脚蹬住挡板，膝盖微屈，上身保持直立不前后大幅摆动。',
    '对握引肘：将V型把手拉至下腹肚脐，肩胛骨用力后收夹紧，顶峰停顿 1 秒。',
    '慢速送出：离心阶段受控向前还原，让背阔肌得到彻底舒展。'
  ],
  '静态悬垂 (死挂)': [
    '放松脊柱：双手与肩同宽正握单杠，双脚离地悬垂，借助重力自然牵引拉伸脊柱。',
    '握力激活：紧扣握把强化前臂耐力，下沉肩胛骨可适度切换为主动悬垂。',
    '平稳呼吸：悬垂全程保持均匀腹式呼吸，避免憋气与剧烈晃动。'
  ],
  '哑铃箭步蹲': [
    '跨步适中：单腿向前跨出一大步，下蹲至前后膝盖均呈约 90 度夹角。',
    '前脚承重：重心始终保持在前腿足弓中央，前膝盖对准第二脚趾，严禁内扣。',
    '躯干挺拔：上身保持垂直或微前倾，双肩下沉，手持哑铃自然垂于体侧。'
  ],
  '哈克深蹲': [
    '背部贴板：后背与头部紧贴靠背，双脚置于踏板中上方，间距与肩同宽。',
    '下蹲充分：屈膝平缓下蹲至大腿与踏板平行，感受股四头肌强力充血。',
    '推起不锁死：脚后跟发力蹬起，推到顶点时膝盖微屈，切勿超伸锁死关节。'
  ],
  '靠墙静蹲': [
    '九十度角：背部贴紧平直墙壁，下蹲至大腿与地面水平、膝关节呈 90 度。',
    '膝对脚尖：双脚踩实地面，膝盖与脚尖方向一致，严禁内扣内倾。',
    '核心收紧：双手自然放在大腿或体侧（不要撑腿），均匀深呼吸坚持目标时长。'
  ],
  '阿诺德推举': [
    '掌心向内启动：哑铃置于锁骨前，掌心朝向自己。',
    '旋转推起：推起过程中同时向外旋转手腕，至推到头顶时掌心朝向正前方。',
    '全程受控：下落时原路旋转还原，动作连贯流畅，全方位刺激三角肌前中束。'
  ],
  '绳索侧平举': [
    '低滑轮定位：将绳索滑轮调至最低点，身体微前倾或微侧倾。',
    '恒定张力：手肘微屈，由三角肌中束主导将把手向上拉至肩高，无重力死角。',
    '沉肩防耸：全程下沉肩胛骨，绝对不要靠斜方肌提肩代偿。'
  ],
  '俯身哑铃飞鸟': [
    '俯身屈髋：微屈膝俯身至躯干接近平行地面，背部挺直紧绷。',
    '肘部领跑：手臂微屈固定，手肘向天花板方向展开至与背同高。',
    '后束孤立：注意不要过度夹紧肩胛骨导致背阔肌代偿，专注三角肌后束发力。'
  ],
  '牧师凳弯举': [
    '大臂贴实：大臂后侧完全贴紧斜板，腋下卡在斜板上缘，杜绝借力空间。',
    '纯粹孤立：双手握杠铃或哑铃，仅以肘关节为轴向上弯举至二头肌最大收缩。',
    '小心下放：下放到手臂接近伸直但肘关节微屈，避免最低点骤停拉伤肌腱。'
  ],
  '绳索过头臂屈伸': [
    '固定大臂：背对龙门架，绳索从身后穿过，大臂竖直贴于耳侧保持不动。',
    '深层拉伸：屈肘让绳索向下深放，充分拉伸肱三头肌长头。',
    '顶峰伸展：三头发力向上伸直小臂，在头顶上方微展绳索顶峰收缩。'
  ],
  '窄距杠铃卧推': [
    '窄握距：双手间距约与肩同宽（约一至一个半掌宽），切忌过窄压迫手腕。',
    '手肘贴身：下放时手肘紧贴躯干两侧（夹角约 30°），避免外展伤肩。',
    '下胸落点：杠铃平稳下放至胸骨剑突部位，三头与胸肌内侧协同推起。'
  ],
  '悬垂举腿': [
    '骨盆后倾卷起：悬挂于单杠，不靠惯性甩腿，依靠腹肌收缩使骨盆向上卷起。',
    '举至水平以上：双腿伸直或微屈，抬至双腿至少与地面平行，感受下腹强烈收缩。',
    '离心慢放：下放时保持腹肌紧绷受控还原，身体不前后晃动摆钟。'
  ],
  '健腹轮': [
    '腹肌卷紧：双膝跪地收腹，背部微呈弧形拱起（骨盆后倾），锁紧核心。',
    '缓慢前推：手臂向前推出，身体在核心可控范围内尽量向前延展，下背严禁塌陷。',
    '腹肌拉回：依靠腹部肌肉主动收缩发力将身体拉回初始跪姿。'
  ],
  '死虫式': [
    '下背压死：仰卧屈膝屈髋90度，双手向上伸直，下背部死死压向地面无缝隙。',
    '对角延伸：对角线侧的手与脚缓慢向外伸展至接近地面，保持躯干稳定不翻滚。',
    '腹横肌发力：全过程核心保持高压，依靠深层腹肌稳定骨盆与脊柱。'
  ],
  '侧平板支撑': [
    '直线中立：手肘撑于肩正下方，侧身将髋部顶起，头、躯干与脚踝呈一条笔直线。',
    '骨盆不掉：下方腹斜肌与臀中肌持续发力，严禁髋部下坠或前后翻转。',
    '腹式呼吸：颈部保持中立，坚持目标时长并保持平稳呼吸。'
  ],
  '波比跳': [
    '连贯流畅：快速俯身双手撑地，双腿向后蹬出成俯卧撑姿势。',
    '俯卧撑受控：胸口贴地完成一次标准俯卧撑，立即收腹收腿回到深蹲姿势。',
    '垂直跃起：双腿蹬地爆发向上跳起，双手击掌于头顶，落地轻盈屈膝缓冲。'
  ],
  '跳绳': [
    '手腕摇绳：大臂自然贴近体侧，仅由手腕发力摇绳，减少多余体能消耗。',
    '脚尖微弹：前脚掌轻盈着地起跳，膝盖微屈缓冲，跳起高度仅需绳子穿过。',
    '呼吸节奏：保持均匀节奏呼吸，核心微收保持躯干正直稳定。'
  ],
  '战绳': [
    '半蹲重心：双脚宽于肩，屈膝微屈髋半蹲，背部平直挺胸，核心高度收紧。',
    '爆发甩动：双手交替或同步由大臂与肩背发力爆发甩动战绳，波浪连绵传至固定端。',
    '全身协同：下肢抓地稳固如磐石，上肢极限轰炸心肺与耐力。'
  ]
};
